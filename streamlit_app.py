...
with tab8:
    ...
    # Use the comprehensive blog system that already exists!
    try:
        from comprehensive_dev_blog_system import ComprehensiveDevBlogSystem
        
        # Initialize the blog system in session state if not exists
        ...
        try:
            from enhanced_blog_integration import integrate_blog_tab
            integrate_blog_tab()
        except:
            # Final fallback UI
            st.info("Blog system is initializing...")
            ...
            with blog_tab2:
                ...
                st.info("Queue monitor initializing...")
                
                # Basic stats
                col1, col2, col3, col4 = st.columns(4)
                
                with col1:
                    st.metric("Total Queued", "0")
                
                with col2:
                    st.metric("Rate Limit Status", "OK")
                
                with col3:
                    st.metric("Failed Messages", "0")
                
                with col4:
                    st.metric("Queue Status", "IDLE")
